...
$query = mysqli_query($conn, "SELECT resolution AS res FROM smartphones WHERE resolution > 0 GROUP BY resolution HAVING COUNT(resolution) > 20 ORDER BY resolution");
